...
def train(nets,Replay,trainHP,HP,trainShared,transgraph):
...
class trainThread (threading.Thread):
   def __init__(self,nets,Replay,trainHP,HP,trainShared,transgraph):
        ...
        self.transgraph = transgraph
      
   def run(self):
        print ("Starting " + self.name)
        train(self.nets,self.Replay,self.trainHP,self.HP,self.trainShared,self.transgraph)
