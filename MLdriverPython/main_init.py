...
if __name__ == "__main__": 
    ...
    HP.save_file_path = os.getcwd()+ "/files/models/no_friction_hard/imitation/"+HP.save_name+"/"
    HP.restore_file_path = os.getcwd()+ "/files/models/no_friction_hard/"+HP.restore_name+"/"
